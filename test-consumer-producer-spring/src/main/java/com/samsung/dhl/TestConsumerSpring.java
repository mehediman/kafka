...
import com.samsung.dhl.consumers.PlainTextConsumer;
...
public class TestConsumerSpring implements CommandLineRunner {
    ...
    public void run(String[] args) {
        ...
        if (process.equalsIgnoreCase(PRODUCER)) {
            ...
            TextMessageProducer kafkaProducer = new TextMessageProducer(topicName, producerProperties);
            ...
            Thread kafkaConsumerThread = new Thread(() -> {
                ...
                PlainTextConsumer simpleKafkaConsumer = new PlainTextConsumer(
                        topicName,
                        consumerProperties
                );
