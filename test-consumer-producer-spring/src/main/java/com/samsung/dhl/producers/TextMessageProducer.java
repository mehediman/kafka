...
public class TextMessageProducer extends BasicProducer {
    private static final Logger logger = Logger.getLogger(TextMessageProducer.class);
    private KafkaProducer<String, String> kafkaProducer;
    private String KAFKA_TOPIC;

    public TextMessageProducer(String messageTopic) {
    ...
    public void startToProduce() {
        ...
        for (int index = 0; index < 10; index++) {
            sendKafkaMessage("This is a no. " + index + " message at timestamp: " + timestamp.getTime());
        }
